...
PORT="${PORT:-5202}"
DB_NAME="${PGDATABASE:-ai_sales_outreach_suite}"

echo "======================================="
echo "      AI Sales Outreach Suite"
echo "======================================="
echo
...
export NEXT_PUBLIC_APP_NAME="AI Sales Outreach Suite"
export NEXT_PUBLIC_LOGIN_EMAIL="admin@ai-sales-outreach.local"
export PORT

echo "Starting ai sales outreach on http://localhost:$PORT"
echo "Login: admin@ai-sales-outreach.local / admin123"
