...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="AI Sales Outreach Suite Dashboard"
      subtitle="One merged ai sales outreach view for Contacts, Lead Scoring, Campaigns, Sequences, Cold Email, LinkedIn Personalization, Reply Analysis, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared ai sales outreach jobs into one surface. Contacts, Lead Scoring, Campaigns, Sequences, Cold Email, LinkedIn Personalization, Reply Analysis, source tables, documents, audit, and AI are presented as platform features.
          </div>
