export const AUTH_COOKIE = 'ai_sales_outreach_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@ai-sales-outreach.local',
    password: 'admin123',
    firstName: 'Suite',
    lastName: 'Admin',
    role: 'admin',
  ...
  {
    email: 'manager@ai-sales-outreach.local',
    password: 'manager123',
    firstName: 'Suite',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@ai-sales-outreach.local',
    password: 'analyst123',
    firstName: 'Suite',
    lastName: 'Analyst',
    role: 'analyst',
