...
export default function LoginPage() {
  ...
  const onSubmit = async (event: FormEvent) => {
    ...
    setSubmitting(false);
    if (!ok) {
      setError('Use the seeded AI Sales Outreach demo credentials.');
      return;
    }
  ...
  return (
    <div className="auth-wrap">
      <div className="auth-card">
        <div className="pill">Sales Outreach</div>
        <h1 style={{ marginBottom: 8 }}>AI Sales Outreach login</h1>
        <div className="muted">
          One login for ai sales outreach features, source tables, documents, notifications, audit, approvals, and AI operations.
        </div>
