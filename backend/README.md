# AI Sales Outreach Suite Backend
...
Operationally, `../start.sh` starts the working full-stack app on port 5202. This backend folder is the stable backend ownership boundary for future extraction to a standalone API service.
