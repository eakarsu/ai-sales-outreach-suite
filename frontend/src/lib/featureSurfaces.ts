...
const featureSeeds = [
  ...
  ["campaign-planner","Campaign Planner","Campaign Planner workspace","Sales Outreach Operations","Review source evidence and assign owner"],
  ["lead-enrichment","Lead Enrichment","Lead Enrichment workspace","Sales Outreach Operations","Confirm findings, next action, and audit evidence"],
  ["outreach-inbox","Outreach Inbox","Outreach Inbox workspace","Sales Outreach Operations","Confirm findings, next action, and audit evidence"],
  ["reply-classification","Reply Classification","Reply Classification workspace","Sales Outreach Operations","Confirm findings, next action, and audit evidence"],
  ["sequence-performance","Sequence Performance","Sequence Performance workspace","Sales Outreach Operations","Confirm findings, next action, and audit evidence"],
